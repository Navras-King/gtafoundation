                            ...
                            <div class="row g-4">
                                <div class="col-md-6 col-lg-6 col-xl-9">
                                    <div class="footer-item">
                                        ...
                                        <a href="#"><i class="fas fa-angle-right me-2"></i> Ministry of Health and Population</a>
                                        <a href="#"><i class="fas fa-angle-right me-2"></i> Department of Health Services</a>
                                        <a href="#"><i class="fas fa-angle-right me-2"></i> Nepal Health Research Council</a>
                                        <a href="#"><i class="fas fa-angle-right me-2"></i> Social Welfare Council</a>
                                        <a href="#"><i class="fas fa-angle-right me-2"></i> Henry Ford Health System</a>
                                        <a href="#"><i class="fas fa-angle-right me-2"></i> International Vaccine Institute</a>
                                        <a href="#"><i class="fas fa-angle-right me-2"></i> John Hopkins University</a>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0">261 Arun Thapa Marg <br />
                                                    Jhamsikhel, LMC-02, Lalitpur <br />
                                        ...
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0">info@gtafoundation.org.np</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-4">
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-end mb-md-0">
                        <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>GTA Foundation</a>, All right reserved.</span>
                    </div>
                    <div class="col-md-6 text-center text-md-start text-body">
                        <!--/*** This template is free as long as you keep the below author’s credit link/attribution link/backlink. ***/-->
                        <!--/*** If you'd like to use the template without the below author’s credit link/attribution link/backlink, ***/-->
                        <!--/*** you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". ***/-->
                        Designed By GTA Foundation
                    </div>
                </div>
            </div>
        </div>
